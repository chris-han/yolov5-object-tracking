...
src_frame_width = int(cap.get(3))
src_frame_height = int(cap.get(4))

# create a mask_data cover the 2/3 src_frame_height and same src_frame_width of frame_size
mask_data = np.zeros((src_frame_height,src_frame_width), np.uint8)
cover_height = int(src_frame_height/6)
mask_data[cover_height:src_frame_height-cover_height-cover_height, 0:src_frame_width] = 255

# display mask_data
cv2.imshow('mask_data', mask_data)
